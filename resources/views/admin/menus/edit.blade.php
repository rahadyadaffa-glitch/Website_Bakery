    ...
    <form action="{{ route('admin.menus.update', $menu) }}" method="POST" enctype="multipart/form-data" class="bg-white p-8 rounded-3xl border border-border shadow-sm max-w-3xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-1">
                ...
                <input type="number" name="price" required value="{{ old('price', $menu->price) }}" class="w-full px-4 py-3 rounded-2xl border-2 border-border focus:border-primary focus:ring-2 focus:ring-primary/20 transition font-heading font-bold text-lg text-primary">
            </div>
